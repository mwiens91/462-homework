...
example generalize to \textit{any} body in \textit{any} uniform flow? My
...
(unless the ball is exactly at the centre). Perhaps this isn't a good
model for the ``ping pong ball in hair dryer flow'' demo?
